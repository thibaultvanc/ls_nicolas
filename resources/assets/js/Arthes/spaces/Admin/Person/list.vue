                ...
                <div v-show="larastrapEditionMode">
                  <a href="/admin/devis/2/tables/60/fields/create" class="btn ">Add columns</a>
                </div>
                     ...
                     <el-checkbox-group v-model="selectListId">
                              ...
                              <table class="table">
                                 <thead>
                                       <tr>
                                             <th>Actions</th>  <th>
                                                              <span v-show="!larastrapEditionMode">Contact_person_id</span>
                                                              <a href="/admin/devis/2/tables/60/fields/424/edit" v-show="larastrapEditionMode">Contact_person_id</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Contact_id</span>
                                                              <a href="/admin/devis/2/tables/60/fields/425/edit" v-show="larastrapEditionMode">Contact_id</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Salutation</span>
                                                              <a href="/admin/devis/2/tables/60/fields/426/edit" v-show="larastrapEditionMode">Salutation</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">First_name</span>
                                                              <a href="/admin/devis/2/tables/60/fields/427/edit" v-show="larastrapEditionMode">First_name</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Last_name</span>
                                                              <a href="/admin/devis/2/tables/60/fields/428/edit" v-show="larastrapEditionMode">Last_name</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Email</span>
                                                              <a href="/admin/devis/2/tables/60/fields/429/edit" v-show="larastrapEditionMode">Email</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Phone</span>
                                                              <a href="/admin/devis/2/tables/60/fields/430/edit" v-show="larastrapEditionMode">Phone</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Mobile</span>
                                                              <a href="/admin/devis/2/tables/60/fields/431/edit" v-show="larastrapEditionMode">Mobile</a>
                                                            </th>
                                    ...
                                    <td>		 {{object.contact_person_id }} 
</a></td><td>		 {{object.contact_id }} 
</a></td><td>		 {{object.salutation}} 
</a></td><td>		 {{object.first_name}} 
</a></td><td>		 {{object.last_name}} 
</a></td><td>		 {{object.email}} 
</a></td><td>		 {{object.phone}} 
</a></td><td>		 {{object.mobile}} 
</a></td>
                                    </tr>
                        ...
                        <el-dialog title="Add new persons" v-model="showmodal" size="large">
                            <person-form force-mode="create" :value="strangerValue"></person-form>
                        ...
                        name: 'person-list',
                          ...
                          fromId:{
                            ...
                            mounted () {
                                    ...
                                    if(this.exceptList){
                                      this.selectListId = this.exceptList.map(x => x.contact_person_id)
                                    }
                            ...
                            methods: {
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Arthes/person/'+ object.contact_person_id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Arthes/person/delete_many',this.selectListId).then(response=>{

                                      this.dataList = this.filterdDataList.filter(object=> this.selectListId.indexOf(object.contact_person_id)<0) //!this.selectListId.indexOf(object.id)<0
                                      this.selectListId=[]
                                      this.$message({
                                        type: 'success',
                                        message: 'Successfully deleted'
                                ...
                                edit (object){
                                    window.location.replace('/Arthes/Admin/person/'+object.contact_person_id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Arthes/Admin/person/'+object.contact_person_id);
                                },
                          ...
                          computed:{
                              ...
                              selectListIdObject () {
                                this.selectList.map(elem=>{elem=contact_person_id})
                              },
