...
<currency-form v-if="mode=='form'" :id="getId"></currency-form>
</transition>
<transition appear name="slide-fade">
<currency-show v-if="mode=='show'" :id="getId"></currency-show>
</transition>
</section>
...
<script>
	...
	import currencyForm from '../Currency/form.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Arthes/currency')
                },
                getUrl(methodName){

                    return '/api/Arthes/currency/'+this.getId+'/'+methodName
                },
