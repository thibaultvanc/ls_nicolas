        ...
        <div class="page-header">
          ...
          <h1>
          <small>
          <el-tag type="primary">contact</el-tag>
...
<contact-form v-if="mode=='form'" :id="getId"></contact-form>
</transition>
<transition appear name="slide-fade">
<contact-show v-if="mode=='show'" :id="getId"></contact-show>
</transition>
</section>
	...
	import contactForm from '../Contact/form.vue'
        ...
        export default {
            ...
            created () {
              ...
              var vm = this
              Event.$on('createdContact', function (createdObject) {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Arthes/contact')
                },
                getUrl(methodName){

                    return '/api/Arthes/contact/'+this.getId+'/'+methodName
                },


                fetchObject () {
                    var vm=this
                    axios.get('/api/Arthes/contact/'+this.getId).then(function (response) {
