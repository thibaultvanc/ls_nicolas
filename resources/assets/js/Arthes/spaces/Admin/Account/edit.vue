        ...
        <div class="page-header">
          ...
          <h1>
          <small>
          <el-tag type="primary">account</el-tag>
...
<account-form v-if="mode=='form'" :id="getId"></account-form>
</transition>
<transition appear name="slide-fade">
<account-show v-if="mode=='show'" :id="getId"></account-show>
</transition>
</section>
...
<script>
	...
	import accountForm from '../Account/form.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Arthes/account')
                },
                getUrl(methodName){

                    return '/api/Arthes/account/'+this.getId+'/'+methodName
                },


                fetchObject () {
                    var vm=this
                    axios.get('/api/Arthes/account/'+this.getId).then(function (response) {
