                ...
                <div v-show="larastrapEditionMode">
                  <a href="/admin/devis/2/tables/53/fields/create" class="btn ">Add columns</a>
                </div>
                                 ...
                                 <thead>
                                       <tr>
                                             <th>Actions</th>  <th>
                                                              ...
                                                              <a href="/admin/devis/2/tables/53/fields/307/edit" v-show="larastrapEditionMode">Account_id</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Account_name</span>
                                                              <a href="/admin/devis/2/tables/53/fields/308/edit" v-show="larastrapEditionMode">Account_name</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Account_code</span>
                                                              <a href="/admin/devis/2/tables/53/fields/309/edit" v-show="larastrapEditionMode">Account_code</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Currency_id</span>
                                                              <a href="/admin/devis/2/tables/53/fields/310/edit" v-show="larastrapEditionMode">Currency_id</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Currency_code</span>
                                                              <a href="/admin/devis/2/tables/53/fields/311/edit" v-show="larastrapEditionMode">Currency_code</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Account_type</span>
                                                              <a href="/admin/devis/2/tables/53/fields/312/edit" v-show="larastrapEditionMode">Account_type</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Is_active</span>
                                                              <a href="/admin/devis/2/tables/53/fields/313/edit" v-show="larastrapEditionMode">Is_active</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Balance</span>
                                                              <a href="/admin/devis/2/tables/53/fields/314/edit" v-show="larastrapEditionMode">Balance</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Bank_balance</span>
                                                              <a href="/admin/devis/2/tables/53/fields/315/edit" v-show="larastrapEditionMode">Bank_balance</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Bcy_balance</span>
                                                              <a href="/admin/devis/2/tables/53/fields/316/edit" v-show="larastrapEditionMode">Bcy_balance</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Bank_name</span>
                                                              <a href="/admin/devis/2/tables/53/fields/317/edit" v-show="larastrapEditionMode">Bank_name</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Routing_number</span>
                                                              <a href="/admin/devis/2/tables/53/fields/318/edit" v-show="larastrapEditionMode">Routing_number</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Is_primary_account</span>
                                                              <a href="/admin/devis/2/tables/53/fields/319/edit" v-show="larastrapEditionMode">Is_primary_account</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Is_paypal_account</span>
                                                              <a href="/admin/devis/2/tables/53/fields/320/edit" v-show="larastrapEditionMode">Is_paypal_account</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Paypal_email_address</span>
                                                              <a href="/admin/devis/2/tables/53/fields/321/edit" v-show="larastrapEditionMode">Paypal_email_address</a>
                                                            </th>
                                    ...
                                    <td>		 {{object.account_id }} 
</a></td><td>		 {{object.account_name}} 
</a></td><td>		 {{object.account_code}} 
</a></td><td>		 {{object.currency_id }} 
</a></td><td>		 {{object.currency_code}} 
</a></td><td>		 {{object.account_type}} 
</a></td><td>		 <i :class="{'el-icon-circle-check' : object.is_active, 'el-icon-circle-cross' : !object.is_active, }" ></i> 
</a></td><td>		 {{object.balance }} 
</a></td><td>		 {{object.bank_balance }} 
</a></td><td>		 {{object.bcy_balance }} 
</a></td><td>		 {{object.bank_name}} 
</a></td><td>		 {{object.routing_number}} 
</a></td><td>		 <i :class="{'el-icon-circle-check' : object.is_primary_account, 'el-icon-circle-cross' : !object.is_primary_account, }" ></i> 
</a></td><td>		 <i :class="{'el-icon-circle-check' : object.is_paypal_account, 'el-icon-circle-cross' : !object.is_paypal_account, }" ></i> 
</a></td><td>		 {{object.paypal_email_address}} 
</a></td>
                                    </tr>
                        ...
                        <el-dialog title="Add new accounts" v-model="showmodal" size="large">
                            <account-form force-mode="create" :value="strangerValue"></account-form>
                        ...
                        name: 'account-list',
                          ...
                          fromId:{
                            ...
                            mounted () {
                                    ...
                                    var vm = this
                                    Event.$on('createdAccount', function (createdObject) {
                                    ...
                                    if(this.exceptList){
                                      this.selectListId = this.exceptList.map(x => x.account_id)
                                    }
                            ...
                            methods: {
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Arthes/account/'+ object.account_id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Arthes/account/delete_many',this.selectListId).then(response=>{

                                      this.dataList = this.filterdDataList.filter(object=> this.selectListId.indexOf(object.account_id)<0) //!this.selectListId.indexOf(object.id)<0
                                      this.selectListId=[]
                                      this.$message({
                                        type: 'success',
                                        message: 'Successfully deleted'
                                ...
                                edit (object){
                                    window.location.replace('/Arthes/Admin/account/'+object.account_id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Arthes/Admin/account/'+object.account_id);
                                },
                          ...
                          computed:{
                              ...
                              selectListIdObject () {
                                this.selectList.map(elem=>{elem=account_id})
                              },
