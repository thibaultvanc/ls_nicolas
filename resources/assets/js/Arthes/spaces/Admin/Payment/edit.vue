        ...
        <div class="page-header">
          ...
          <h1>
          <small>
          <el-tag type="primary">payment</el-tag>
...
<payment-form v-if="mode=='form'" :id="getId"></payment-form>
</transition>
<transition appear name="slide-fade">
<payment-show v-if="mode=='show'" :id="getId"></payment-show>
</transition>
</section>
...
<script>
	...
	import paymentForm from '../Payment/form.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Arthes/payment')
                },
                getUrl(methodName){

                    return '/api/Arthes/payment/'+this.getId+'/'+methodName
                },


                fetchObject () {
                    var vm=this
                    axios.get('/api/Arthes/payment/'+this.getId).then(function (response) {
