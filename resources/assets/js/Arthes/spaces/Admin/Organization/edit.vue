...
<organization-form v-if="mode=='form'" :id="getId"></organization-form>
</transition>
<transition appear name="slide-fade">
<organization-show v-if="mode=='show'" :id="getId"></organization-show>
</transition>
</section>
...
<script>
	...
	import organizationForm from '../Organization/form.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Arthes/organization')
                },
                getUrl(methodName){

                    return '/api/Arthes/organization/'+this.getId+'/'+methodName
                },


                fetchObject () {
                    var vm=this
                    axios.get('/api/Arthes/organization/'+this.getId).then(function (response) {
