                ...
                <div v-show="larastrapEditionMode">
                  <a href="/admin/devis/2/tables/56/fields/create" class="btn ">Add columns</a>
                </div>
                     ...
                     <el-checkbox-group v-model="selectListId">
                              ...
                              <table class="table">
                                 <thead>
                                       <tr>
                                             <th>Actions</th>  <th>
                                                              <span v-show="!larastrapEditionMode">Invoice_id</span>
                                                              <a href="/admin/devis/2/tables/56/fields/351/edit" v-show="larastrapEditionMode">Invoice_id</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Customer_name</span>
                                                              <a href="/admin/devis/2/tables/56/fields/352/edit" v-show="larastrapEditionMode">Customer_name</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Customer_id</span>
                                                              <a href="/admin/devis/2/tables/56/fields/353/edit" v-show="larastrapEditionMode">Customer_id</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Status</span>
                                                              <a href="/admin/devis/2/tables/56/fields/354/edit" v-show="larastrapEditionMode">Status</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Invoice_number</span>
                                                              <a href="/admin/devis/2/tables/56/fields/355/edit" v-show="larastrapEditionMode">Invoice_number</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Reference_number</span>
                                                              <a href="/admin/devis/2/tables/56/fields/356/edit" v-show="larastrapEditionMode">Reference_number</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Date</span>
                                                              <a href="/admin/devis/2/tables/56/fields/357/edit" v-show="larastrapEditionMode">Date</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Due_date</span>
                                                              <a href="/admin/devis/2/tables/56/fields/358/edit" v-show="larastrapEditionMode">Due_date</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Due_days</span>
                                                              <a href="/admin/devis/2/tables/56/fields/359/edit" v-show="larastrapEditionMode">Due_days</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Currency_id</span>
                                                              <a href="/admin/devis/2/tables/56/fields/360/edit" v-show="larastrapEditionMode">Currency_id</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Currency_code</span>
                                                              <a href="/admin/devis/2/tables/56/fields/361/edit" v-show="larastrapEditionMode">Currency_code</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Is_viewed_by_client</span>
                                                              <a href="/admin/devis/2/tables/56/fields/362/edit" v-show="larastrapEditionMode">Is_viewed_by_client</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Total</span>
                                                              <a href="/admin/devis/2/tables/56/fields/363/edit" v-show="larastrapEditionMode">Total</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Balance</span>
                                                              <a href="/admin/devis/2/tables/56/fields/364/edit" v-show="larastrapEditionMode">Balance</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Is_emailed</span>
                                                              <a href="/admin/devis/2/tables/56/fields/365/edit" v-show="larastrapEditionMode">Is_emailed</a>
                                                            </th>
 <th>
                                                              <span v-show="!larastrapEditionMode">Reminders_sent</span>
                                                              <a href="/admin/devis/2/tables/56/fields/366/edit" v-show="larastrapEditionMode">Reminders_sent</a>
                                                            </th>
...
</a></td><td>		 {{object.invoice_number}} 
</a></td><td>		 {{object.reference_number}} 
</a></td><td>		 {{object.date}} 
</a></td><td>		 {{object.due_date}} 
</a></td><td>		 {{object.due_days }} 
</a></td><td>		 {{object.currency_id }} 
</a></td><td>		 {{object.currency_code}} 
</a></td><td>		 <i :class="{'el-icon-circle-check' : object.is_viewed_by_client, 'el-icon-circle-cross' : !object.is_viewed_by_client, }" ></i> 
</a></td><td>		 {{object.total }} 
</a></td><td>		 {{object.balance }} 
</a></td><td>		 <i :class="{'el-icon-circle-check' : object.is_emailed, 'el-icon-circle-cross' : !object.is_emailed, }" ></i> 
</a></td><td>		 <i :class="{'el-icon-circle-check' : object.reminders_sent, 'el-icon-circle-cross' : !object.reminders_sent, }" ></i> 
</a></td>
                                    </tr>
                        ...
                        <el-dialog title="Add new invoices" v-model="showmodal" size="large">
                            <invoice-form force-mode="create" :value="strangerValue"></invoice-form>
                        ...
                        name: 'invoice-list',
                          ...
                          fromId:{
                            ...
                            mounted () {
                                    ...
                                    var vm = this
                                    Event.$on('createdInvoice', function (createdObject) {
                                    ...
                                    if(this.exceptList){
                                      this.selectListId = this.exceptList.map(x => x.invoice_id)
                                    }
                            ...
                            methods: {
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Arthes/invoice/'+ object.invoice_id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Arthes/invoice/delete_many',this.selectListId).then(response=>{

                                      this.dataList = this.filterdDataList.filter(object=> this.selectListId.indexOf(object.invoice_id)<0) //!this.selectListId.indexOf(object.id)<0
                                      this.selectListId=[]
                                      this.$message({
                                        type: 'success',
                                        message: 'Successfully deleted'
                                ...
                                edit (object){
                                    window.location.replace('/Arthes/Admin/invoice/'+object.invoice_id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Arthes/Admin/invoice/'+object.invoice_id);
                                },
                          ...
                          computed:{
                              ...
                              selectListIdObject () {
                                this.selectList.map(elem=>{elem=invoice_id})
                              },
