        ...
        <div class="page-header">
          ...
          <h1>
          <small>
          <el-tag type="primary">invoice</el-tag>
...
<invoice-form v-if="mode=='form'" :id="getId"></invoice-form>
</transition>
<transition appear name="slide-fade">
<invoice-show v-if="mode=='show'" :id="getId"></invoice-show>
</transition>
</section>
...
<script>
	...
	import invoiceForm from '../Invoice/form.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Arthes/invoice')
                },
                getUrl(methodName){

                    return '/api/Arthes/invoice/'+this.getId+'/'+methodName
                },


                fetchObject () {
                    var vm=this
                    axios.get('/api/Arthes/invoice/'+this.getId).then(function (response) {
