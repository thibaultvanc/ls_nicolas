    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.PermissionRole.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/10/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/10/fields/38/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.PermissionRole.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/permission_role/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/permission_role/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/permission_role/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/permission_role/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/permission_role'
                              },
