    ...
    <div class="well">
        <h2>{{ $t('Picaflor.PermissionRole.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="permission_id" class="col-sm-2 control-label">{{ $t('Picaflor.PermissionRole.fields.permission_id.label') }}</label>
      <div class="col-sm-10 ">
      ...
      <label for="role_id" class="col-sm-2 control-label">{{ $t('Picaflor.PermissionRole.fields.role_id.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.role_id }} 
            ...
            export default {
                ...
                methods: {
                        fetchObject () {
                            var vm=this
                            axios.get('/api/Picaflor/permission_role/'+this.getId).then(function (response) {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/permission_role/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/permission_role/'+getId, object).then(function (response) {
                        vm.sending=false
