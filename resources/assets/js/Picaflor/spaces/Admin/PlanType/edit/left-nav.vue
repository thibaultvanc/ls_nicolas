    ...
    <style>
      ...
      <div class="page-header">
        ...
        <h1>
        <small>
        <el-tag type="primary">plan_type</el-tag>
      ...
      <br>
          ...
          <div class="tabbable">
              ...
              <div class="tab-content col-md-8">
                  ...
                  <el-button v-if="mode=='show'" type="primary" @click="mode='form'">{{$t('core.edit')}}</el-button><el-button v-if="mode=='form'" @click="mode='show'">{{$t('core.cancel')}}</el-button><transition appear name="fade" mode="out-in"> <plan-type-form v-if="mode=='form'" :id="getId"></plan-type-form> </transition><transition appear name="fade" mode="in-out"> <plan-type-show v-if="mode=='show'" :id="getId"></plan-type-show> </transition>
                  </div>
                  
                                 <div class="tab-pane fade in" id="plans">
                                    <plans from="plan_type" :plan_type="id" :fromId="id" :url="getUrl('plans')"></plans>
                                 </div>
...
import plans from '../..//list/basic.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Picaflor/plan_type')
                },
                getUrl(methodName){

                    return '/api/Picaflor/plan_type/'+this.getId+'/'+methodName
                },
