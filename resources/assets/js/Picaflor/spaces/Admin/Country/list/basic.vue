    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.Country.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/14/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/14/fields/48/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Country.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/5/tables/14/fields/49/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Country.fields.name.label') }}
                                                          </a>
                                                        </th>
                    ...
                    <el-dialog title="Add new countries" v-model="showmodal" size="large">
                        <country-form force-mode="create" :value="strangerValue"></country-form>
                      <span slot="footer" class="dialog-footer">
                        <el-button @click="showmodal = false">{{ $t('core.cancel') }}</el-button>
                            ...
                            <el-dialog title="Attach Existing countries" v-model="showmodalAttach_countries" size="large">

                            <country-list choose-mode :except-list.sync="dataList" :from="from" :from-id="fromId">
                              </country-list>

                              <span slot="footer" class="dialog-footer">
                                <el-button @click="closemodalAttach_countries">{{ $t('core.cancel') }}</el-button>
                                <!--<el-button type="primary" @click="showmodalAttach_countries = false, showmodal = true">{{ $t('core.createNew') }} countries</el-button>-->
                              </span>
                            </el-dialog>
	...
	import countryList from './basic.vue'
                          ...
                          fromId:{
                            ...
                            data(){
                                return {
                                    ...
                                    showmodalAttach_countries:false
                            ...
                            methods: {
                                ...
                                // },
                                    ...
                                    closemodalAttach_countries (){
                                      this.fetchData(countries)
                                      this.showmodalAttach_devis = false

                                    },

                                    clickAttach_countries (){
                                            // if(this.$route.params.id){
                                                this.showmodalAttach_countries=!this.showmodalAttach_countries
                                            // }else{
                                                // this.$router.push('/country/create')
                                            // }
                                    },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Picaflor/'+this.from+'/'+this.fromId+'/attach_countries', this.selectListId).then(reponse=>{
                                      console.log('submitAttachButton')


                                      Event.$emit('attached', 'countries')
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/country/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/country/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/country/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/country/'+object.id);
                                },
