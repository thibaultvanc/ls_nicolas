    ...
    <div class="well">
        <h2>{{ $t('Picaflor.OrganizationUser.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="organization_id" class="col-sm-2 control-label">{{ $t('Picaflor.OrganizationUser.fields.organization_id.label') }}</label>
      <div class="col-sm-10 ">
      ...
      <label for="user_id" class="col-sm-2 control-label">{{ $t('Picaflor.OrganizationUser.fields.user_id.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.user_id }} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/organization_user/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/organization_user/'+getId, object).then(function (response) {
                        vm.sending=false
