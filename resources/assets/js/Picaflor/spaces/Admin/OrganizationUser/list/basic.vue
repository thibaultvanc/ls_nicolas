    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.OrganizationUser.index') }}</h2>
            </div>
            ...
            <!-- <h1>OrganizationUser  List</h1>-->
            <!--<pre>chooseMode : {{chooseMode}}</pre>
            <pre>exceptList : {{exceptList}}</pre>-->

            <div v-show="larastrapEditionMode">
            <a href="/admin/devis/5/tables/31/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/31/fields/102/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.OrganizationUser.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
 ...
 <th>
                    ...
                    <el-dialog title="Add new organization_user" v-model="showmodal" size="large">
                        <organization-user-form force-mode="create" :value="strangerValue"></organization-user-form>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/organization_user/create')
                                        // }
                                },
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/organization_user/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/organization_user/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/organization_user/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/organization_user/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/organization_user'
                              },
