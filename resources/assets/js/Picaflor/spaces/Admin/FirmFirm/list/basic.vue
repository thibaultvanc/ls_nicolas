    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.FirmFirm.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/34/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/34/fields/133/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.FirmFirm.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Firm_id</span>
                                                          <a href="/admin/devis/5/tables/34/fields/134/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.FirmFirm.fields.firm_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Composedby_firm_id</span>
                                                          <a href="/admin/devis/5/tables/34/fields/135/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.FirmFirm.fields.composedby_firm_id.label') }}
                                                          </a>
                                                        </th>
                                ...
                                <td>		 {{object.id }} 
</a></td><td>		 {{object.firm_id }} 
</a></td><td>		 {{object.composedby_firm_id }} 
</a></td>
                                </tr>
                    ...
                    <el-dialog title="Add new firm_firm" v-model="showmodal" size="large">
                        <firm-firm-form force-mode="create" :value="strangerValue"></firm-firm-form>
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/firm_firm/create')
                                        // }
                                },
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/firm_firm/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/firm_firm/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/firm_firm/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/firm_firm/'+object.id);
                                },
