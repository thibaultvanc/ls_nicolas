    ...
    <div class="ibox-content">
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Picaflor.Role.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
      ...
      <label for="label" class="col-sm-2 control-label">{{ $t('Picaflor.Role.fields.label.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.label}} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/role/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/role/'+getId, object).then(function (response) {
                        vm.sending=false
