    ...
    <style>
            ...
            <a href="/admin/devis/5/tables/8/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/8/fields/32/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Role.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/5/tables/8/fields/33/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Role.fields.name.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Label</span>
                                                          <a href="/admin/devis/5/tables/8/fields/34/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Role.fields.label.label') }}
                                                          </a>
                                                        </th>
                            ...
                            methods: {
                                ...
                                // },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Picaflor/'+this.from+'/'+this.fromId+'/attach_roles', this.selectListId).then(reponse=>{
                                ...
                                clickDelete (object){
                                  ...
                                  detach_User  (item){
                                    ...
                                    var vm = this
                                    axios.post('/api/Picaflor/user/'+ this.fromId + '/detach_role/' + item.id).then(response=>{
                                  ...
                                  detach_Permission  (item){
                                    ...
                                    console.log('detaching !', item)
                                    var vm = this
                                    axios.post('/api/Picaflor/permission/'+ this.fromId + '/detach_role/' + item.id).then(response=>{
                                      //Route::post("devis/{devis}/detach_product/1", "Arthes\Web\DevisApiController@attach_products");
                                      // var index = vm.dataList.indexOf(object)
                                      // vm.dataList.splice(index,1)
                                      // vm.refresh()
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/role/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/role/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/role/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/role/'+object.id);
                                },
