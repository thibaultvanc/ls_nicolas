    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.ProductType.index') }}</h2>
            </div>
            ...
            <!-- <h1>ProductType  List</h1>-->
            <!--<pre>chooseMode : {{chooseMode}}</pre>
            <pre>exceptList : {{exceptList}}</pre>-->

            <div v-show="larastrapEditionMode">
            <a href="/admin/devis/5/tables/29/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/29/fields/95/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.ProductType.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/5/tables/29/fields/96/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.ProductType.fields.name.label') }}
                                                          </a>
                                                        </th>
                    ...
                    <el-dialog title="Add new product_types" v-model="showmodal" size="large">
                        <product-type-form force-mode="create" :value="strangerValue"></product-type-form>
                      <span slot="footer" class="dialog-footer">
                        <el-button @click="showmodal = false">{{ $t('core.cancel') }}</el-button>
                            ...
                            <el-dialog title="Attach Existing product_types" v-model="showmodalAttach_product_types" size="large">

                            <product-type-list choose-mode :except-list.sync="dataList" :from="from" :from-id="fromId">
                              </product-type-list>

                              <span slot="footer" class="dialog-footer">
                                <el-button @click="closemodalAttach_product_types">{{ $t('core.cancel') }}</el-button>
                                <!--<el-button type="primary" @click="showmodalAttach_product_types = false, showmodal = true">{{ $t('core.createNew') }} product_types</el-button>-->
                              </span>
                            </el-dialog>
                ...
                window.Event=new Vue()
                	...
                	import productTypeForm from '../form/basic.vue'
	import productTypeList from './basic.vue'
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            data(){
                                return {
                                    ...
                                    showmodalAttach_product_types:false
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/product_type/create')
                                        // }
                                },
                                ...
                                // },
                                    ...
                                    closemodalAttach_product_types (){
                                      this.fetchData(product_types)
                                      this.showmodalAttach_devis = false

                                    },

                                    clickAttach_product_types (){
                                            // if(this.$route.params.id){
                                                this.showmodalAttach_product_types=!this.showmodalAttach_product_types
                                            // }else{
                                                // this.$router.push('/product_type/create')
                                            // }
                                    },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Picaflor/'+this.from+'/'+this.fromId+'/attach_product_types', this.selectListId).then(reponse=>{
                                      console.log('submitAttachButton')


                                      Event.$emit('attached', 'product_types')
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/product_type/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/product_type/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/product_type/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/product_type/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/product_type'
                              },
