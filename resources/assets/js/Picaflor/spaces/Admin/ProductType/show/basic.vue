    ...
    <div class="well">
        <h2>{{ $t('Picaflor.ProductType.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Picaflor.ProductType.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/product_type/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/product_type/'+getId, object).then(function (response) {
                        vm.sending=false
