    ...
    <style>
            ...
            <a href="/admin/devis/5/tables/32/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
 ...
 <th>
          ...
          {{ object.brand_id.name }}
                    ...
                    <el-dialog title="Add new adresses" v-model="showmodal" size="large">
                        <adress-form force-mode="create" :value="strangerValue"></adress-form>
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/adress/create')
                                        // }
                                },
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/adress/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/adress/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/adress/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/adress/'+object.id);
                                },
