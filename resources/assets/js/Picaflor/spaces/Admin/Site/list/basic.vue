    ...
    <style>
            ...
            <a href="/admin/devis/5/tables/19/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/19/fields/60/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Site.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/5/tables/19/fields/61/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Site.fields.name.label') }}
                                                          </a>
                                                        </th>
                    ...
                    <el-dialog title="Add new sites" v-model="showmodal" size="large">
                        <site-form force-mode="create" :value="strangerValue"></site-form>
                      <span slot="footer" class="dialog-footer">
                        <el-button @click="showmodal = false">{{ $t('core.cancel') }}</el-button>
                            ...
                            <el-dialog title="Attach Existing sites" v-model="showmodalAttach_sites" size="large">

                            <site-list choose-mode :except-list.sync="dataList" :from="from" :from-id="fromId">
                              </site-list>

                              <span slot="footer" class="dialog-footer">
                                <el-button @click="closemodalAttach_sites">{{ $t('core.cancel') }}</el-button>
                                <!--<el-button type="primary" @click="showmodalAttach_sites = false, showmodal = true">{{ $t('core.createNew') }} sites</el-button>-->
                              </span>
                            </el-dialog>
                ...
                window.Event=new Vue()
                	...
                	import siteForm from '../form/basic.vue'
	import siteList from './basic.vue'
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                // },
                                    ...
                                    closemodalAttach_sites (){
                                      this.fetchData(sites)
                                    ...
                                    clickAttach_sites (){
                                            // if(this.$route.params.id){
                                                this.showmodalAttach_sites=!this.showmodalAttach_sites
                                            // }else{
                                                // this.$router.push('/site/create')
                                            // }
                                    },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Picaflor/'+this.from+'/'+this.fromId+'/attach_sites', this.selectListId).then(reponse=>{
                                      console.log('submitAttachButton')


                                      Event.$emit('attached', 'sites')
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/site/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/site/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/site/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/site/'+object.id);
                                },
