    ...
    <div class="ibox-content">
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Picaflor.Site.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/site/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/site/'+getId, object).then(function (response) {
                        vm.sending=false
