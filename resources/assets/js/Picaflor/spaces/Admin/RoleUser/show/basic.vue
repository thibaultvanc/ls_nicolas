    ...
    <div class="well">
        <h2>{{ $t('Picaflor.RoleUser.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="user_id" class="col-sm-2 control-label">{{ $t('Picaflor.RoleUser.fields.user_id.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.user_id }} 
      ...
      <label for="role_id" class="col-sm-2 control-label">{{ $t('Picaflor.RoleUser.fields.role_id.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.role_id }} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/role_user/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/role_user/'+getId, object).then(function (response) {
                        vm.sending=false
