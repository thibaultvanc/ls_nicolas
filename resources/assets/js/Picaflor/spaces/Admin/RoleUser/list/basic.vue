    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.RoleUser.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/7/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/7/fields/29/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.RoleUser.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">User</span>
                                                          <a href="/admin/devis/5/tables/7/fields/30/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.RoleUser.fields.user_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Role</span>
                                                          <a href="/admin/devis/5/tables/7/fields/31/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.RoleUser.fields.role_id.label') }}
                                                          </a>
                                                        </th>
                    ...
                    <el-dialog title="Add new role_user" v-model="showmodal" size="large">
                        <role-user-form force-mode="create" :value="strangerValue"></role-user-form>
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/role_user/create')
                                        // }
                                },
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/role_user/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/role_user/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/role_user/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/role_user/'+object.id);
                                },
