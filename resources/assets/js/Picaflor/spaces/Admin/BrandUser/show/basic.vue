    ...
    <div class="well">
        <h2>{{ $t('Picaflor.BrandUser.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="brand_id" class="col-sm-2 control-label">{{ $t('Picaflor.BrandUser.fields.brand_id.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.brand_id }} 
      ...
      <label for="user_id" class="col-sm-2 control-label">{{ $t('Picaflor.BrandUser.fields.user_id.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.user_id }} 
      ...
      <label for="country_id" class="col-sm-2 control-label">{{ $t('Picaflor.BrandUser.fields.country_id.label') }}</label>
      <div class="col-sm-10 ">
          ...
          {{ object.country.name }}
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/brand_user/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/brand_user/'+getId, object).then(function (response) {
                        vm.sending=false
