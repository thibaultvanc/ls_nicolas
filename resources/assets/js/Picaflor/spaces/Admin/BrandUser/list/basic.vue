    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.BrandUser.index') }}</h2>
            </div>
            ...
            <!-- <h1>BrandUser  List</h1>-->
            <!--<pre>chooseMode : {{chooseMode}}</pre>
            <pre>exceptList : {{exceptList}}</pre>-->

            <div v-show="larastrapEditionMode">
            <a href="/admin/devis/5/tables/13/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/13/fields/45/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.BrandUser.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Brand_id</span>
                                                          <a href="/admin/devis/5/tables/13/fields/46/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.BrandUser.fields.brand_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">User_id</span>
                                                          <a href="/admin/devis/5/tables/13/fields/47/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.BrandUser.fields.user_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Country_id</span>
                                                          <a href="/admin/devis/5/tables/13/fields/51/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.BrandUser.fields.country_id.label') }}
                                                          </a>
                                                        </th>
          ...
          {{ object.country.name }}
                    ...
                    <el-dialog title="Add new brand_user" v-model="showmodal" size="large">
                        <brand-user-form force-mode="create" :value="strangerValue"></brand-user-form>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/brand_user/create')
                                        // }
                                },
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/brand_user/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/brand_user/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/brand_user/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/brand_user/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/brand_user'
                              },
