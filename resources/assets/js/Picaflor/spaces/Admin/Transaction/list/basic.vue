    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.Transaction.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/18/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                ...
                <el-dropdown v-if="!selectListId.length">
                 ...
                 <div class="pull-right">
                    ...
                    <span ><el-button type="primary" @click="clickAdd" icon="plus" v-if="!selectListId.length">{{ $t('core.add') }}</el-button></span>
                                      ...
                                      <span v-if="!!fromId && from=='payment_provider'">
                                      <el-button type="primary" @click="clickAdd" icon="plus" >{{ $t('core.add') }}</el-button>
                                      </span>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/18/fields/58/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Transaction.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/5/tables/18/fields/59/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Transaction.fields.name.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Invoices_id</span>
                                                          <a href="/admin/devis/5/tables/18/fields/66/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Transaction.fields.invoices_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Payment_provider_id</span>
                                                          <a href="/admin/devis/5/tables/18/fields/79/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Transaction.fields.payment_provider_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">User_id</span>
                                                          <a href="/admin/devis/5/tables/18/fields/80/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Transaction.fields.user_id.label') }}
                                                          </a>
                                                        </th>
          ...
          {{ object.payment_provider.name }}
                    ...
                    <el-dialog title="Add new transactions" v-model="showmodal" size="large">
                        <transaction-form force-mode="create" :value="strangerValue"></transaction-form>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/transaction/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/transaction/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/transaction/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/transaction/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/transaction'
                              },
