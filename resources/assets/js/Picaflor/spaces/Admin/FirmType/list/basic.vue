    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.FirmType.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/33/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/33/fields/130/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.FirmType.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/5/tables/33/fields/131/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.FirmType.fields.name.label') }}
                                                          </a>
                                                        </th>
                    ...
                    <el-dialog title="Add new firm_types" v-model="showmodal" size="large">
                        <firm-type-form force-mode="create" :value="strangerValue"></firm-type-form>
                      <span slot="footer" class="dialog-footer">
                        <el-button @click="showmodal = false">{{ $t('core.cancel') }}</el-button>
                            ...
                            <el-dialog title="Attach Existing firm_types" v-model="showmodalAttach_firm_types" size="large">

                            <firm-type-list choose-mode :except-list.sync="dataList" :from="from" :from-id="fromId">
                              </firm-type-list>

                              <span slot="footer" class="dialog-footer">
                                <el-button @click="closemodalAttach_firm_types">{{ $t('core.cancel') }}</el-button>
                                <!--<el-button type="primary" @click="showmodalAttach_firm_types = false, showmodal = true">{{ $t('core.createNew') }} firm_types</el-button>-->
                              </span>
                            </el-dialog>
                ...
                window.Event=new Vue()
                	...
                	import firmTypeForm from '../form/basic.vue'
	import firmTypeList from './basic.vue'
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            mounted () {
                                    ...
                                    var vm = this
                                    Event.$on('createdFirmType', function (createdObject) {
                            ...
                            data(){
                                return {
                                    ...
                                    showmodalAttach_firm_types:false
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/firm_type/create')
                                        // }
                                },
                                ...
                                // },
                                    ...
                                    closemodalAttach_firm_types (){
                                      this.fetchData(firm_types)
                                      this.showmodalAttach_devis = false

                                    },

                                    clickAttach_firm_types (){
                                            // if(this.$route.params.id){
                                                this.showmodalAttach_firm_types=!this.showmodalAttach_firm_types
                                            // }else{
                                                // this.$router.push('/firm_type/create')
                                            // }
                                    },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Picaflor/'+this.from+'/'+this.fromId+'/attach_firm_types', this.selectListId).then(reponse=>{
                                      console.log('submitAttachButton')


                                      Event.$emit('attached', 'firm_types')
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/firm_type/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/firm_type/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/firm_type/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/firm_type/'+object.id);
                                },
