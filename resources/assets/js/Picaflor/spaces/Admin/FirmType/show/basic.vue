    ...
    <div class="well">
        <h2>{{ $t('Picaflor.FirmType.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Picaflor.FirmType.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/firm_type/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/firm_type/'+getId, object).then(function (response) {
                        vm.sending=false
