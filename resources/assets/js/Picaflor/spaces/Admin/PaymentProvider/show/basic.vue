    ...
    <div class="well">
        <h2>{{ $t('Picaflor.PaymentProvider.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Picaflor.PaymentProvider.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/payment_provider/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/payment_provider/'+getId, object).then(function (response) {
                        vm.sending=false
