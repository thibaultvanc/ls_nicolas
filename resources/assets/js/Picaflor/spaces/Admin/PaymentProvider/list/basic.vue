    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.PaymentProvider.index') }}</h2>
            </div>
            ...
            <!-- <h1>PaymentProvider  List</h1>-->
            <!--<pre>chooseMode : {{chooseMode}}</pre>
            <pre>exceptList : {{exceptList}}</pre>-->

            <div v-show="larastrapEditionMode">
            <a href="/admin/devis/5/tables/25/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/25/fields/77/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.PaymentProvider.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/5/tables/25/fields/78/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.PaymentProvider.fields.name.label') }}
                                                          </a>
                                                        </th>
                    ...
                    <el-dialog title="Add new payment_providers" v-model="showmodal" size="large">
                        <payment-provider-form force-mode="create" :value="strangerValue"></payment-provider-form>
                      <span slot="footer" class="dialog-footer">
                        <el-button @click="showmodal = false">{{ $t('core.cancel') }}</el-button>
                            ...
                            <el-dialog title="Attach Existing payment_providers" v-model="showmodalAttach_payment_providers" size="large">

                            <payment-provider-list choose-mode :except-list.sync="dataList" :from="from" :from-id="fromId">
                              </payment-provider-list>

                              <span slot="footer" class="dialog-footer">
                                <el-button @click="closemodalAttach_payment_providers">{{ $t('core.cancel') }}</el-button>
                                <!--<el-button type="primary" @click="showmodalAttach_payment_providers = false, showmodal = true">{{ $t('core.createNew') }} payment_providers</el-button>-->
                              </span>
                            </el-dialog>
                ...
                window.Event=new Vue()
                	...
                	import paymentProviderForm from '../form/basic.vue'
	import paymentProviderList from './basic.vue'
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            data(){
                                return {
                                    ...
                                    showmodalAttach_payment_providers:false
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/payment_provider/create')
                                        // }
                                },
                                ...
                                // },
                                    ...
                                    closemodalAttach_payment_providers (){
                                      this.fetchData(payment_providers)
                                      this.showmodalAttach_devis = false

                                    },

                                    clickAttach_payment_providers (){
                                            // if(this.$route.params.id){
                                                this.showmodalAttach_payment_providers=!this.showmodalAttach_payment_providers
                                            // }else{
                                                // this.$router.push('/payment_provider/create')
                                            // }
                                    },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Picaflor/'+this.from+'/'+this.fromId+'/attach_payment_providers', this.selectListId).then(reponse=>{
                                      console.log('submitAttachButton')


                                      Event.$emit('attached', 'payment_providers')
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/payment_provider/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/payment_provider/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/payment_provider/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/payment_provider/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/payment_provider'
                              },
