    ...
    <style>
      ...
      <div class="page-header">
        ...
        <h1>
        <small>
        <el-tag type="primary">plan_family</el-tag>
        </small>
      ...
      <br>
          ...
          <div class="tabbable">
              ...
              <div class="tab-content col-md-8">
                  ...
                  <el-button v-if="mode=='show'" type="primary" @click="mode='form'">Edit</el-button><el-button v-if="mode=='form'" @click="mode='show'">Cancel</el-button><transition appear name="fade" mode="out-in"> <plan-family-form v-if="mode=='form'" :id="getId"></plan-family-form> </transition><transition appear name="fade" mode="in-out"> <plan-family-show v-if="mode=='show'" :id="getId"></plan-family-show> </transition>
                  </div>
                  
                                 <div class="tab-pane fade in" id="plans">
                                    <plans from="plan_family" :plan_family="id" :fromId="id" :url="getUrl('plans')"></plans>
                                 </div>
...
import plans from '../..//list/basic.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Picaflor/plan_family')
                },
                getUrl(methodName){

                    return '/api/Picaflor/plan_family/'+this.getId+'/'+methodName
                },
