    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.Organization.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/30/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                ...
                <el-dropdown v-if="!selectListId.length">
                 ...
                 <div class="pull-right">
                    ...
                    <span ><el-button type="primary" @click="clickAdd" icon="plus" v-if="!selectListId.length">{{ $t('core.add') }}</el-button></span>
                                      ...
                                      <el-button type="primary" icon="plus" @click="clickAttach_organizations" v-if="!selectListId.length" >{{ $t('core.attach') }}  BTM</el-button>
                                      </span>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/30/fields/99/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Organization.fields.name.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Id</span>
                                                          <a href="/admin/devis/5/tables/30/fields/103/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.Organization.fields.id.label') }}
                                                          </a>
                                                        </th>
                                  ...
                                  <tr  v-for="object in filterdDataList" :key="object">
                                    <td>
                                        ...
                                        <el-button @click="clickDetach_User(object)" icon="delete" size="mini"
                                                    v-show="!chooseMode && from && from=='user'" >{{ $t('core.detach') }} fromUser</el-button>


                                        &nbsp;&nbsp;&nbsp;
                                        <el-checkbox :label="object.id" ></el-checkbox>
                                    </td>
                                <td><a href="#" @click="edit(object)">		 {{object.name}} 
</a></td><td>		 {{object.id }} 
</a></td>
                                </tr>
                    ...
                    <el-dialog title="Add new organizations" v-model="showmodal" size="large">
                      ...
                      <span slot="footer" class="dialog-footer">
                        <el-button @click="showmodal = false">{{ $t('core.cancel') }}</el-button>
                            ...
                            <el-dialog title="Attach Existing organizations" v-model="showmodalAttach_organizations" size="large">

                            <organization-list choose-mode :except-list.sync="dataList" :from="from" :from-id="fromId">
                              </organization-list>

                              <span slot="footer" class="dialog-footer">
                                <el-button @click="closemodalAttach_organizations">{{ $t('core.cancel') }}</el-button>
                                <!--<el-button type="primary" @click="showmodalAttach_organizations = false, showmodal = true">{{ $t('core.createNew') }} organizations</el-button>-->
                              </span>
                            </el-dialog>
	...
	import organizationList from './basic.vue'
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            data(){
                                return {
                                    ...
                                    showmodalAttach_organizations:false
                            ...
                            methods: {
                                ...
                                // },
                                    ...
                                    closemodalAttach_organizations (){
                                      this.fetchData(organizations)
                                      this.showmodalAttach_devis = false

                                    },

                                    clickAttach_organizations (){
                                            // if(this.$route.params.id){
                                                this.showmodalAttach_organizations=!this.showmodalAttach_organizations
                                            // }else{
                                                // this.$router.push('/organization/create')
                                            // }
                                    },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Picaflor/'+this.from+'/'+this.fromId+'/attach_organizations', this.selectListId).then(reponse=>{
                                      console.log('submitAttachButton')


                                      Event.$emit('attached', 'organizations')
                                ...
                                clickDelete (object){
                                  ...
                                  clickDetach_User (item) {
                                    ...
                                    this.$confirm('This will remove the organization in this '+this.from+'. Continue?', 'Warning', {
                                      confirmButtonText: this.$t('core.ok'),
                                      cancelButtonText: this.$t('core.cancel'),
                                      type: 'warning'
                                    }).then(() => {
                                  ...
                                  detach_User  (item){
                                    ...
                                    var vm = this
                                    axios.post('/api/Picaflor/user/'+ this.fromId + '/detach_organization/' + item.id).then(response=>{
                                      ...
                                      Event.$emit('detached', 'organizations')
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/organization/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/organization/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/organization/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/organization/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/organization'
                              },
