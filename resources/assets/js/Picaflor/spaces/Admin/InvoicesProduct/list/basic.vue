    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.InvoicesProduct.index') }}</h2>
            </div>
            ...
            <!-- <h1>InvoicesProduct  List</h1>-->
            <!--<pre>chooseMode : {{chooseMode}}</pre>
            <pre>exceptList : {{exceptList}}</pre>-->

            <div v-show="larastrapEditionMode">
            <a href="/admin/devis/5/tables/20/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/5/tables/20/fields/62/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.InvoicesProduct.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          ...
                                                          {{ $t('Picaflor.InvoicesProduct.fields.invoices_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Product_id</span>
                                                          <a href="/admin/devis/5/tables/20/fields/64/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Picaflor.InvoicesProduct.fields.product_id.label') }}
                                                          </a>
                                                        </th>
                                ...
                                <td>		 {{object.id }} 
</a></td><td>		 {{object.invoices_id }} 
</a></td><td>		 {{object.product_id }} 
</a></td>
                                </tr>
                    ...
                    <el-dialog title="Add new invoices_product" v-model="showmodal" size="large">
                        <invoices-product-form force-mode="create" :value="strangerValue"></invoices-product-form>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/invoices_product/create')
                                        // }
                                },
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/invoices_product/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/invoices_product/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/invoices_product/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/invoices_product/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/invoices_product'
                              },
