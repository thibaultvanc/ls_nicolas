    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Picaflor.Subscription.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/5/tables/22/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
 ...
 <th>
          ...
          {{ object.plan.name }}
                    ...
                    <el-dialog title="Add new subscriptions" v-model="showmodal" size="large">
                        <subscription-form force-mode="create" :value="strangerValue"></subscription-form>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Picaflor/subscription/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Picaflor/subscription/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Picaflor/Admin/subscription/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Picaflor/Admin/subscription/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Picaflor/subscription'
                              },
