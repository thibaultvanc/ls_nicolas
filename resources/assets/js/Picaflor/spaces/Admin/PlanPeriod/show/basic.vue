    ...
    <div class="well">
        <h2>{{ $t('Picaflor.PlanPeriod.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Picaflor.PlanPeriod.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
      ...
      <label for="slug" class="col-sm-2 control-label">{{ $t('Picaflor.PlanPeriod.fields.slug.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.slug}} 
            ...
            export default {
                ...
                methods: {
                        ...
                        edit (object){
                            window.location.replace('/Picaflor/plan_period/'+object.id+'/edit');
                        },
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Picaflor/plan_period/'+getId, object).then(function (response) {
                        vm.sending=false
