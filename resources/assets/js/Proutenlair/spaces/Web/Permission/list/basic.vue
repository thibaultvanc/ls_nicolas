    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Proutenlair.Permission.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/18/tables/66/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          {{ $t('Proutenlair.Permission.fields.label.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Id</span>
                                                          <a href="/admin/devis/18/tables/66/fields/254/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.Permission.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/18/tables/66/fields/255/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.Permission.fields.name.label') }}
                                                          </a>
                                                        </th>
                        ...
                        props :{
                            ...
                            methods: {
                                ...
                                // },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Proutenlair/'+this.from+'/'+this.fromId+'/attach_permissions', this.selectListId).then(reponse=>{
                                ...
                                clickDelete (object){
                                  ...
                                  detach_Role  (item){
                                    ...
                                    var vm = this
                                    axios.post('/api/Proutenlair/role/'+ this.fromId + '/detach_permission/' + item.id).then(response=>{
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Proutenlair/permission/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Proutenlair/permission/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Proutenlair/permission/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Proutenlair/permission/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Proutenlair/permission'
                              },
