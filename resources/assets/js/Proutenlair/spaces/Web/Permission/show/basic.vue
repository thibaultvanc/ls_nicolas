    ...
    <div class="well">
        <h2>{{ $t('Proutenlair.Permission.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="label" class="col-sm-2 control-label">{{ $t('Proutenlair.Permission.fields.label.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.label}} 
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Proutenlair.Permission.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
            ...
            export default {
                ...
                methods: {
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Proutenlair/permission/'+getId, object).then(function (response) {
                        vm.sending=false
