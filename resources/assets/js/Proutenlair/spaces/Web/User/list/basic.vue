    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Proutenlair.User.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/18/tables/63/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/18/tables/63/fields/240/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.User.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">First Name</span>
                                                          <a href="/admin/devis/18/tables/63/fields/241/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.User.fields.firstname.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Name</span>
                                                          <a href="/admin/devis/18/tables/63/fields/242/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.User.fields.lastname.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Phone</span>
                                                          <a href="/admin/devis/18/tables/63/fields/243/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.User.fields.phone.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Email</span>
                                                          <a href="/admin/devis/18/tables/63/fields/244/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.User.fields.email.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Is admin</span>
                                                          <a href="/admin/devis/18/tables/63/fields/247/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.User.fields.is_admin.label') }}
                                                          </a>
                                                        </th>
                            ...
                            methods: {
                                ...
                                // },
                                  ...
                                  submitAttachButton () {
                                    ...
                                    axios.post('/api/Proutenlair/'+this.from+'/'+this.fromId+'/attach_users', this.selectListId).then(reponse=>{
                                ...
                                clickDelete (object){
                                  ...
                                  detach_Role  (item){
                                    ...
                                    var vm = this
                                    axios.post('/api/Proutenlair/role/'+ this.fromId + '/detach_user/' + item.id).then(response=>{
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Proutenlair/user/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Proutenlair/user/delete_many',this.selectListId).then(response=>{
                                ...
                                show (object){
                                    window.location.replace('/Proutenlair/user/'+object.id);
                                },
