    ...
    <div class="ibox-content">
      ...
      <label for="name" class="col-sm-2 control-label">{{ $t('Proutenlair.Role.fields.name.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.name}} 
      ...
      <label for="label" class="col-sm-2 control-label">{{ $t('Proutenlair.Role.fields.label.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.label}} 
            ...
            export default {
                ...
                methods: {
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Proutenlair/role/'+getId, object).then(function (response) {
                        vm.sending=false
