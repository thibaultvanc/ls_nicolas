      ...
      <br>
          ...
          <div class="tabbable">
              <ul class="nav nav-pills nav-stacked col-md-3">
                  ...
                  <li class=""><a href="#users" data-toggle="tab">users**BTM**</a></li><li class=""><a href="#permissions" data-toggle="tab">permissions**BTM**</a></li>
              </ul>
...
import permissions from '../../Permission/list/basic.vue'
        ...
        export default {
            ...
            methods: {
                goBack(){
                    window.location.replace('/Proutenlair/role')
                },
                getUrl(methodName){

                    return '/api/Proutenlair/role/'+this.getId+'/'+methodName
                },


                fetchObject () {
                    var vm=this
                    axios.get('/api/Proutenlair/role/'+this.getId).then(function (response) {
