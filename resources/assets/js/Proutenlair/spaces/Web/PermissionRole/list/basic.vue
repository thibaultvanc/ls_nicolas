    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Proutenlair.PermissionRole.index') }}</h2>
            </div>
            ...
            <!-- <h1>PermissionRole  List</h1>-->
            <!--<pre>chooseMode : {{chooseMode}}</pre>
            <pre>exceptList : {{exceptList}}</pre>-->

            <div v-show="larastrapEditionMode">
            <a href="/admin/devis/18/tables/67/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                             ...
                             <thead>
                                   <tr>
                                         <th>{{ $t('core.actions') }}</th>  <th>
                                                          ...
                                                          <a href="/admin/devis/18/tables/67/fields/257/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.PermissionRole.fields.id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Permission</span>
                                                          <a href="/admin/devis/18/tables/67/fields/258/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.PermissionRole.fields.permission_id.label') }}
                                                          </a>
                                                        </th>
 <th>
                                                          <span v-show="!larastrapEditionMode">Role</span>
                                                          <a href="/admin/devis/18/tables/67/fields/259/edit" v-show="larastrapEditionMode">
                                                          {{ $t('Proutenlair.PermissionRole.fields.role_id.label') }}
                                                          </a>
                                                        </th>
                                ...
                                <td>		 {{object.id }} 
</a></td><td>		 {{object.permission_id }} 
</a></td><td>		 {{object.role_id }} 
</a></td>
                                </tr>
                    ...
                    <el-dialog title="Add new permission_role" v-model="showmodal" size="large">
                        <permission-role-form force-mode="create" :value="strangerValue"></permission-role-form>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                clickAdd (){
                                        ...
                                        // }else{
                                        //     this.$router.push('/permission_role/create')
                                        // }
                                },
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Proutenlair/permission_role/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Proutenlair/permission_role/delete_many',this.selectListId).then(response=>{
                                ...
                                edit (object){
                                    window.location.replace('/Proutenlair/permission_role/'+object.id+'/edit');
                                },

                                show (object){
                                    window.location.replace('/Proutenlair/permission_role/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Proutenlair/permission_role'
                              },
