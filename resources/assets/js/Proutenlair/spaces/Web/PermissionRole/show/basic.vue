    ...
    <div class="well">
        <h2>{{ $t('Proutenlair.PermissionRole.show') }}</h2>
    </div>
    ...
    <div class="ibox-content">
      ...
      <label for="permission_id" class="col-sm-2 control-label">{{ $t('Proutenlair.PermissionRole.fields.permission_id.label') }}</label>
      <div class="col-sm-10 ">
      ...
      <label for="role_id" class="col-sm-2 control-label">{{ $t('Proutenlair.PermissionRole.fields.role_id.label') }}</label>
      <div class="col-sm-10 ">
      		 {{object.role_id }} 
            ...
            export default {
                ...
                methods: {
                    ...
                    deleteObject(object) {
                        ...
                        var vm=this
                        axios.delete('/api/Proutenlair/permission_role/'+getId, object).then(function (response) {
                        vm.sending=false
