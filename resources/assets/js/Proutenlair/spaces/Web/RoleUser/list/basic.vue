    ...
    <style>
            ...
            <div class="well">
                <h2>{{ $t('Proutenlair.RoleUser.index') }}</h2>
            </div>
            ...
            <a href="/admin/devis/18/tables/64/fields/create" class="btn ">{{ $t('larastrap.manageTable') }}</a>
            </div>
                        ...
                        props :{
                          ...
                          fromId:{
                            ...
                            methods: {
                                ...
                                delete (object){
                                    var vm=this
                                    axios.delete('/api/Proutenlair/role_user/'+ object.id).then(response=>{
                                ...
                                deleteMany (){
                                    var vm=this
                                    axios.post('/api/Proutenlair/role_user/delete_many',this.selectListId).then(response=>{
                                ...
                                show (object){
                                    window.location.replace('/Proutenlair/role_user/'+object.id);
                                },
                          ...
                          computed:{
                              ...
                              fetchUrl (){
                                  ...
                                  return '/api/Proutenlair/role_user'
                              },
