...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-59093025", module.exports)
  } else {
    hotAPI.update("_v-59093025", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],46:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
exports.default = {
    ...
    ready: function ready() {
        console.log('messages component ready');
        //this.fetchMessages()
    },
    data: function data() {
        return {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n\n\n\n    slug_domain\n    <input type=\"text\" v-model=\"slug_domain\">\n\n    extension\n    <input type=\"text\" v-model=\"extension\">\n\n\n    <div class=\"well\">\n        Edition du domaine :\n        <center>\n            <h2>{{slug_domain}}.{{extension}}</h2>\n        </center>\n    </div>\n\n    <!-- #v2# -->\n    <div class=\" alert alert-warning\"><b>Pour le moment, les valeurs sont updatées via les 2 champs inputs -&gt; reccuperer le domaine de l'objet devis. note:  on l'a dans vue, mais il faut ajouter le champ \"domaine\" (project.com)\n        <p>\n            il faudra extraire l'extention (.com) et mettre .app pour le local\n        </p>\n\n        note : en m$eme temps de la migration, ajouter le champ : server_id, pour savoir sur quel serveur on le place\n    </b></div><b>\n\n\n    <div class=\" alert alert-info\"><b>Pour modifier cette Page</b><br>organit &gt; resources\\assets\\js\\components\\bootstrapping.vue</div>\n\n\n\n    <div class=\"alert alert-info\">--&gt; acheter des noms de domaines standards ... pour MEL</div>\n\n\n\n\n\n\n\n\n\n\n    <h1>Getting Started</h1>\n    <p>\n\n    </p>\n    <ul>\n\n\n        <li><input type=\"checkbox\"> aller dans Code/</li>\n        <li><input type=\"checkbox\"> copier et renommer le dossier bootstrapping avec le nom du projet : <b>{{slug_domain}}</b></li>\n        <li><input type=\"checkbox\"> click droit sur le nouveau dossier &gt; lancer commandr dans le dossier</li>\n    </ul>\n\n\n\n\n\n\n    <h2>Pas de ligne de commande</h2>\n\n    <br><br><br>\n    <hr>\n    <h3>en parrallele:</h3>\n    <br>\n\n<ul>\n        <li><input type=\"checkbox\"> ouvrir le dosser project name sur atom editor</li>\n        <li><input type=\"checkbox\"> remplir le dossier .env</li>\n\n    </ul>\n\n\n    <br><br><br>\n    <hr>\n    <h3>en parrallele:</h3>\n    <br>\n<ul>\n        <li><input type=\"checkbox\"> mettre le logo dans public/img/logo.png</li>\n\n    </ul>\n\n\n    <br><br><br>\n    <hr>\n    <h3>en parrallele:</h3>\n    <br>\n<ul>\n        <li><input type=\"checkbox\"> Configuration du nom de domaine sur GAndi (ou celui du client)</li>\n\n    </ul>\n\n\n    <br><br><br>\n    <hr>\n    <h3>en parrallele:</h3>\n    <br>\n<ul>\n        <li><input type=\"checkbox\"> verifier le fichier de migrations pour ajouter des champs (optionnel)</li>\n\n    </ul>\n\n\n\n\n    <h2>Ligne de commande sans ssh</h2>\n\n\n\n        <br><br><br>\n        <hr>\n        <h3>en parrallele:</h3>\n        <br>\n\n        <ul>\n            <li>\n                <input type=\"checkbox\"> <i class=\"fa fa-console\"><code></code></i><code>Homestead up</code>\n            </li>\n        </ul>\n\n\n        <br><br><br>\n        <hr>\n        <h3>en parrallele:</h3>\n        <br>\n<ul>\n            <li><input type=\"checkbox\"> <i class=\"fa fa-console\"><code>npm install</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\"> <i class=\"fa fa-console\"><code>gulp</code> (pour tester)</i></li><i class=\"fa fa-console\">\n\n    </i></i></ul><i class=\"fa fa-console\"><i class=\"fa fa-console\">\n\n        <br><br><br>\n        <hr>\n        <h3>en parrallele:</h3>\n        <br>\n\n        <ul>\n            <li><input type=\"checkbox\">  github &gt; creation repo &gt; <a href=\"https://github.com/new\">New repo</a> &gt; nommer : {{slug_domain}}</li>\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>git init</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>git add .</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>git commit -m \"first commit\"</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>git remote add origin https://github.com/thibaultvanc/{{slug_domain}}.git</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>git push -u origin master</code></i></li><i class=\"fa fa-console\">\n\n            </i></i></i></i></i></ul><i class=\"fa fa-console\"><i class=\"fa fa-console\"><i class=\"fa fa-console\">\n\n\n        <br>\n        <br>\n        <br>\n        <br>\n\n\n        <h2>puis (apres github is finished )</h2>\n        <h3>Forge installation</h3>\n\n        <h5>en parralle</h5>\n        <ul>\n            <li><input type=\"checkbox\"> choix du nom de domaine sur gandi ou demander au clien ses acces\n                <p>\n                    <label for=\"\">production_domain</label><input v-model=\"production_domain\"></p></li>\n\n                    <label for=\"\">production_domain</label><input v-model=\"exploitation_domain\">\n\n                <p></p>\n            <li><input type=\"checkbox\"> choix du server distant sur forge\n\n                <div><label for=\"\"></label><input v-model=\"production_server\"></div>\n                <div><label for=\"\"></label><input v-model=\"exploitation_server\"></div>\n\n            </li><li><input type=\"checkbox\"> config du nom de domaine pour pointer sur le server forge</li>\n        </ul>\n        <br>\n        <br>\n        <br>\n\n\n\n        <li><input type=\"checkbox\"> creation domaine et choix server sur forge</li>\n\n<br>\n        <li><input type=\"checkbox\"> choisir le repo github : <input v-model=\"github\"></li>\n        <li><input type=\"checkbox\"> choix du nom de domaine <input v-model=\"production_domain\"></li>\n\n<br>\n\n        <li><input type=\"checkbox\"> choisir le repo github</li>\n        <li><input type=\"checkbox\"> activer le mode auto publish</li>\n        <li><input type=\"checkbox\"> changer le script d'excecution -&gt; php artisan migrate:refresh --seed</li>\n        <li><input type=\"checkbox\"> editer fichier environnement</li>\n\n<br>\n\n        <h5>se connecter en ssh sur FORGE pour creer la BDD</h5>\n        <ul>\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>ssh forge@104.131.35.207 -i ~/.ssh/id_rsa</code>    (ici elvis)</i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"> creation bdd SUR MYSQL <code>mysql -u forge -p</code>     (password : 6Jw1GCXLYadyTSOh73NJ)</i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>CREATE DATABASE IF NOT EXISTS {{slug_domain}} ;</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>show databases;</code></i></li><i class=\"fa fa-console\">\n            </i></i></i></i></ul><i class=\"fa fa-console\"><i class=\"fa fa-console\"><i class=\"fa fa-console\">\n<br>\n\n        <h5>installation ssl</h5>\n    <ul>\n        <li><input type=\"checkbox\"> installation ssl</li>\n        </ul>\n\n\n\n\n\n        <br><br><br>\n        <hr>\n        <h3>en parrallele:</h3>\n        <br>\n        <ul>\n            <li><input type=\"checkbox\"> homestead yaml (placer en debut sinon, conflit avec mlm-valley)\n                <pre>                    - map: {{slug_domain}}.{{extension}}\n                    to: /home/vagrant/Code/{{slug_domain}}/public\n                </pre>\n            </li>\n            <li><input type=\"checkbox\"> hosts\n                <pre>192.168.10.10    {{slug_domain}}.{{extension}}</pre>\n            </li>\n\n            <li><input type=\"checkbox\"> <i class=\"fa fa-console\"><code> homestead provision</code></i></li><i class=\"fa fa-console\">\n\n        </i></ul><i class=\"fa fa-console\">\n\n\n\n\n\n        <h2>Ligne de commande <div class=\"label label-info\">SSH</div></h2>\n\n\n        <br><br><br>\n        <hr>\n        <h3>en parrallele:</h3>\n        <br>\n        <h5>composer</h5>\n        <ul>\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code> homestead ssh</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code> cd Code/{{slug_domain}}</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code> composer install</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code> composer dump-autoload -o</code></i></li><i class=\"fa fa-console\">\n\n            </i></i></i></i></ul><i class=\"fa fa-console\"><i class=\"fa fa-console\"><i class=\"fa fa-console\">\n\n        <br><br><br>\n        <hr>\n        <h3>en parrallele:</h3>\n        <br>\n        <h5>creation de la BDD Locale</h5>\n        <ul>\n            <li><input type=\"checkbox\"> creation bdd SUR MYSQL     <i class=\"fa fa-console\"><code> mysql -u homestead -p </code>     (password : secret)</i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\"> <i class=\"fa fa-console\"><code>CREATE DATABASE IF NOT EXISTS {{slug_domain}} ;</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code> show databases;</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">_ use {{slug_domain}};    ///pui select * ... (optionnel)</li>\n\n            </i></i></i></ul><i class=\"fa fa-console\"><i class=\"fa fa-console\"><i class=\"fa fa-console\">\n\n            <p>ctrl + c (leave mysql)</p>\n\n\n\n\n\n\n        <h3>Migrations</h3>\n        ----------------------------\n        <ul>\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>php artisan migrate</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>php artisan migrate:refresh --seed</code></i></li><i class=\"fa fa-console\">\n            <li><input type=\"checkbox\">  <i class=\"fa fa-console\"><code>php artisan vendor:publish</code></i></li><i class=\"fa fa-console\">\n            </i></i></i></ul><i class=\"fa fa-console\"><i class=\"fa fa-console\"><i class=\"fa fa-console\">\n\n\n\n\n\n        <div class=\"well\">\n\n                <center>\n                    <h5>TESTER {{slug_domain}}.{{extension}} dans le navigateur</h5>\n                </center>\n\n\n        </div>\n\n\n\n<ul>\n\n\n            <li><input type=\"checkbox\">lister DES MODels\n            <p>\n                <!-- #v2# -->\n                <i>V2 : connexion avec les tables via vue.js</i>\n            </p>\n            </li>\n            <li><input type=\"checkbox\">Lister les champs de chaque Model</li>\n\n            <!-- #v2# -->\n            <li><input type=\"checkbox\">Dermander par mail au client la liste des champs qu'il veut (v2 auto)</li>\n\n            <li><input type=\"checkbox\">Définir les relations entre les models</li>\n\n            <li><input type=\"checkbox\">extraire le crud ? </li>\n\n            <!-- #v2# -->\n            <li><input type=\"checkbox\">cREATION Du MVC + migrations</li>\n\n            <!-- #v2# -->\n            <li><input type=\"checkbox\">creation des seeds / faker</li>\n\n            <li><input type=\"checkbox\">choix des themes pour chaque space</li>\n    </ul>\n\n\n\n\n\n\n        <h2>mise en prod exploitation</h2>\n\n        <h5>forge</h5>\n<ul>\n            <li><input type=\"checkbox\"> changer le script d'excecution -&gt; php artisan migrate:refresh --seed  &gt;&gt;&gt;&gt;&gt; php artisan migrate --force</li>\n\n            <li><input type=\"checkbox\"> Changer les codes stripes ou autre dans les variables environnement</li>\n\n    </ul>\n\n\n</i></i></i></i></i></i></i></i></i></i></i></i></i></i></i></i></i></i></b>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-72f626ae", module.exports)
  } else {
    hotAPI.update("_v-72f626ae", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],47:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	filters: {
		inlist: function inlist(fields, _inlist) {
		...
		show: function show(fields, _show) {
			return fields.filter(function (field) {
				//console.log( field.inList)
				return field.show;
			});
		...
		mode: function mode(fields, _mode) {
	...
	computed: {
		...
		addFieldButtonIcon: function addFieldButtonIcon() {
		...
		createFieldButtonIcon: function createFieldButtonIcon() {
	...
	methods: {
		...
		showCreateFieldForm: function showCreateFieldForm() {
			this.mode = 'create';
		...
		showEditFieldForm: function showEditFieldForm(field) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-74c31285", module.exports)
  } else {
    hotAPI.update("_v-74c31285", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],48:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n")
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        editPivotTable: function editPivotTable() {
            this.showEditPivotTableName = true;
        },
        editPivotFieldRelation2: function editPivotFieldRelation2() {
            this.showEditPivotFieldNameRelation2 = true;
        },
        ...
        submit: function submit() {
            ...
            this.$http.get('/admin/devis/' + this.devis.id + '/post_update_belongs_to_many/' + this.relation1.from_field_id + '/' + this.relation1.to_field_id, this.form).then(function (response) {
                alert('');
            });
        }
    }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d38bb9e6", module.exports)
  } else {
    hotAPI.update("_v-d38bb9e6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],49:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        fetchFieldList: function fetchFieldList() {
        ...
        deleteRecord: function deleteRecord(record) {
            record_id = record[(0, _keys2.default)(record)[0]];
        ...
        update: function update(record) {
            ...
            this.editing_id = record[(0, _keys2.default)(record)[0]];
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5c095b12", module.exports)
  } else {
    hotAPI.update("_v-5c095b12", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/object/keys":2,"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],50:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
    ...
    computed: {
        block_background: function block_background() {
    ...
    methods: {
        accept: function accept(message) {
            this.load = true;
            this.action = 'accept';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7ef19110", module.exports)
  } else {
    hotAPI.update("_v-7ef19110", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],51:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
    ...
    filters: {
        ...
        seeResponse: function seeResponse(messages, responseType) {
    ...
    methods: {
        ...
        show_todo: function show_todo() {
            this.responseType = null;
            this.all = false;
        },
        show_accepted: function show_accepted() {
            this.responseType = 1;
            this.all = false;
        },
        show_rejected: function show_rejected() {
            this.responseType = 0;
            this.all = false;
        },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-62ec3213", module.exports)
  } else {
    hotAPI.update("_v-62ec3213", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./message.vue":50,"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],52:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
    ...
    methods: {
        ...
        fetchFieldList: function fetchFieldList() {
            ...
            this.$http.get('/api/table/' + this.table.id + '/fields').then(function (response) {
                ...
                this.fieldList.map(function (field) {
                    ...
                    field.relations.map(function (relation) {
                        ...
                        if (relation.pivot.laravel_name == 'belongsTo') {
                            ...
                            _this.$http.get('/api/table/' + relation.table.id + '/records').then(function (response) {
                                ...
                                response.data.map(function (data) {
                                    ...
                                    keyLabel.push({ key: key, label: label });
                                });
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-bf537d0a", module.exports)
  } else {
    hotAPI.update("_v-bf537d0a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
  ...
  */
	...
	data: function data() {
		...
		return _ref = {
			...
			editFieldSubmitButtonText: 'Mettre à jour',
			loader: '<i class="fa fa-spin fa-spinner"></i>'
		}, (0, _defineProperty3.default)(_ref, 'fieldList', []), (0, _defineProperty3.default)(_ref, 'alert', { show: false, type: '', content: '' }), _ref;
	},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-9ca59120", module.exports)
  } else {
    hotAPI.update("_v-9ca59120", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/helpers/defineProperty":3,"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],54:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n/* always present */\n.expand-transition {\n  -webkit-transition: all 1s ease;\n  transition: all 1s ease;\n  overflow: hidden;\n}\n\n\n.expand-enter, .expand-leave {\n  height: 0;\n  opacity: 0;\n}\n\n")
'use strict';
...
exports.default = {
  ...
  filters: {
    provider: function provider(providerList, type) {
      return providerList.filter(function (provider) {
        return provider['is_' + type + '_manager'];
      });
    },

    available: function available(roles, user_roles) {
      console.log(roles);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-08500873", module.exports)
  } else {
    hotAPI.update("_v-08500873", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":43,"vue-hot-reload-api":41,"vueify/lib/insert-css":44}],55:[function(require,module,exports){
'use strict';
...
var _crud = require('./components/crud.vue');

var _crud2 = _interopRequireDefault(_crud);

var _settings_client = require('./components/settings_client.vue');

var _settings_client2 = _interopRequireDefault(_settings_client);

var _settings_users = require('./components/settings_users.vue');

var _settings_users2 = _interopRequireDefault(_settings_users);

var _bootstrapping = require('./components/bootstrapping.vue');

var _bootstrapping2 = _interopRequireDefault(_bootstrapping);

var _setFixedValues = require('./components/setFixedValues.vue');

var _setFixedValues2 = _interopRequireDefault(_setFixedValues);

var _editTableData = require('./components/editTableData.vue');

var _editTableData2 = _interopRequireDefault(_editTableData);

var _editBelongsToMany = require('./components/editBelongsToMany.vue');

var _editBelongsToMany2 = _interopRequireDefault(_editBelongsToMany);
...
new Vue({
	el: 'body',
	components: {
		alert: _alert2.default, messages: _messages2.default, crud: _crud2.default, settingsUsers: _settings_users2.default, settingsClient: _settings_client2.default, bootstrapping: _bootstrapping2.default, setFixedValues: _setFixedValues2.default, editTableData: _editTableData2.default, editBelongsToMany: _editBelongsToMany2.default
	},
	ready: function ready() {
...
},{"./components/alert.vue":45,"./components/bootstrapping.vue":46,"./components/crud.vue":47,"./components/editBelongsToMany.vue":48,"./components/editTableData.vue":49,"./components/messages.vue":51,"./components/setFixedValues.vue":52,"./components/settings_client.vue":53,"./components/settings_users.vue":54,"vue":43,"vue-resource":42}]},{},[55]);
