				...
				$.ajax({
					...
					success: function (data) {
						if (data.response == "success") {
							...
							/*Add by AGV -> redirección a /?p=sp_contact <- From here:*/

							window.location.replace("http://"+window.location.hostname+"/?p=sp_newsletter");
							...
							/*$("#newsletterError").html(data.message);
								...
								$("#newsletterForm #email")
									...
									.closest(".control-group")
									.removeClass("success")
									.addClass("error");*//*AGV Original code -> error si exists <-*/

							/*Modified by AGV -> error si exists <- From here:*/
							...
							if(data.response == "exists"){
								...
								$("#newsletterError").html("<b>Error</b> : email already exists in our newsletter");
